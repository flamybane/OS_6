...
def inf_memory(memory):
    while True:
        ...
        if deistvie == "1":
            ...
            kol_vo_pages = input("Введите количество страниц:")
            for i in range(kol_vo_pages):
                number_pages = input("Введите номер страницы")
...
def delete_memory(columns, size_page):
    while True:
        ...
        if delete == "1":
            ...
            kol_vo_delete = input("Введите количество страниц:")
            for i in range(kol_vo_delete):
                number_page1 = input("Введите номер страницы")
        ...
        def main():
            ...
            while menu != "Exit":
                if menu == "1":
                    ...
                    delete_memory(columns, size_page)
                else:
